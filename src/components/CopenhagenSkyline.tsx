    ...
    >
      <defs>
        <linearGradient id="skyGradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="oklch(0.95 0.02 240)" />
      ...
      >
        ...
        <rect x="65" y="135" width="10" height="10" fill="currentColor" className="text-primary" opacity="0.4" />
        <rect x="65" y="155" width="10" height="10" fill="currentColor" className="text-primary" opacity="0.4" />
        <rect x="85" y="135" width="10" height="10" fill="currentColor" className="text-primary" opacity="0.4" />
        <rect x="85" y="155" width="10" height="10" fill="currentColor" className="text-primary" opacity="0.4" />
      </motion.g>
      ...
      <motion.g
        ...
        style={{ transformOrigin: 'center bottom' }}
      >
        <rect x="150" y="100" width="70" height="80" stroke="currentColor" strokeWidth="2" fill="none" className="text-primary" />
        ...
        <rect x="190" y="115" width="12" height="12" fill="currentColor" className="text-primary" opacity="0.4" />
        <rect x="190" y="140" width="12" height="12" fill="currentColor" className="text-primary" opacity="0.4" />
        <rect x="190" y="165" width="12" height="12" fill="currentColor" className="text-primary" opacity="0.4" />
      </motion.g>
      ...
      <motion.g
        initial={{ scaleY: 0 }}
        animate={{ scaleY: 1 }}
        transition={{ duration: 0.73, delay: 1.1 }}
        style={{ transformOrigin: 'center bottom' }}
      >
