    ...
    >
      <defs>
        ...
        <linearGradient id="buildingGradient2" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="oklch(0.70 0.18 320)" stopOpacity="0.15" />
          <stop offset="100%" stopColor="oklch(0.70 0.18 320)" stopOpacity="0.08" />
        </linearGradient>
        <linearGradient id="buildingGradient3" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="oklch(0.65 0.25 35)" stopOpacity="0.15" />
          <stop offset="100%" stopColor="oklch(0.65 0.25 35)" stopOpacity="0.08" />
        </linearGradient>
        <linearGradient id="bridgeGradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="oklch(0.55 0.22 260)" stopOpacity="0.2" />
          <stop offset="100%" stopColor="oklch(0.55 0.22 260)" stopOpacity="0.1" />
        </linearGradient>
      </defs>
