        ...
        >
          ...
          <div className="prose prose-slate max-w-none">
            <div className="space-y-8 text-foreground">
              <section>
                <h2 className="text-2xl font-semibold mb-4">Your Terms Content</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Please provide your terms of use text for 7Plates. This is a placeholder page that will be populated with your legal content.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  The content should include sections covering user agreements, acceptable use, limitations of liability, and any other relevant terms for your application.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Your terms of use content will replace this placeholder text.
                </p>
              </section>
        ...
        <div className="mx-auto max-w-6xl px-6 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm">
              ...
              <Link to="/7plates/terms" className="text-primary font-medium">
                Terms of Use
              </Link>
            </div>
          </div>
