...
import { Brain, DeviceMobile, AppWindow, PaperPlaneTilt, EnvelopeSimple, CheckCircle, ForkKnife } from '@phosphor-icons/react'
    ...
    <div className="min-h-screen bg-background">
      <main className="mx-auto max-w-6xl px-6">
        ...
        <section className="py-24 md:py-32">
          ...
          >
            <Link to="/7plates">
              <Card className="transition-all duration-200 hover:shadow-xl hover:-translate-y-2 border-border cursor-pointer">
                <CardContent className="p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
                  <div className="flex-shrink-0">
                    <div className="w-24 h-24 md:w-32 md:h-32 rounded-3xl overflow-hidden shadow-lg bg-gradient-to-br from-[oklch(0.65_0.18_140)] to-[oklch(0.55_0.20_160)] flex items-center justify-center">
                      <div className="text-white text-5xl md:text-6xl font-bold">7</div>
                    </div>
                  </div>
                  <div className="flex-1 text-center md:text-left">
                    <h3 className="text-2xl md:text-3xl font-semibold text-foreground mb-3 flex items-center justify-center md:justify-start gap-2">
                      <ForkKnife weight="thin" className="w-7 h-7" />
                      7Plates
                    </h3>
                    <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                      Weekly meal planning made effortless. Get personalized recipes, smart shopping lists, and stress-free meals every week.
                    </p>
                  </div>
                </CardContent>
              </Card>
